...
for r in range(num_rows):
   ...
   all_components.append(pca.components_)
...
print("Averaged PCA loadings shape:", avg_components.shape)


np.save('averaged_pca_loadings.npy', avg_components)
...
for r in range(num_rows):
   ...
   data_pca_final = data_gaussian @ avg_components.T
